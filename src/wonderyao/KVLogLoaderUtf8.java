...
import wonderyao.KVLogLoader.KVField;

public class KVLogLoaderUtf8 extends LoadFunc{
	...
	public KVLogLoaderUtf8(String fieldsStr){
		this(fieldsStr, false);
	}
	
    public KVLogLoaderUtf8(String fieldsStr, Boolean hasHead){
